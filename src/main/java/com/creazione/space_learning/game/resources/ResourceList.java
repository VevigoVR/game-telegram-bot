...
public class ResourceList {
    ...
    public static final List<ResourceDto> RESOURCES_LIST = List.of(
            new Crypto(),
            new Coin(),
            new Knowledge(),
            new Gold(),
    ...
    public String toString() {
        ...
        for (ResourceDto resource : RESOURCES_LIST) {
    ...
    public static ResourceDto createResource(String name, Long quantity) {
