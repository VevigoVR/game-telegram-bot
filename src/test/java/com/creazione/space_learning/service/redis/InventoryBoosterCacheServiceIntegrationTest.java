...
class InventoryBoosterCacheServiceIntegrationTest {
    ...
    void testGetInventoryBoosterByName() {
        ...
        Optional<InventoryBoosterP> foundBooster = inventoryBoosterCacheService.getInventoryBooster(USER_ID, "ACCELERATION_ALL");
    ...
    void testGetInventoryBoostersByType() {
        ...
        List<InventoryBoosterP> metalBoosters = inventoryBoosterCacheService.getInventoryBoostersByName(USER_ID, ResourceType.ACCELERATION_METAL);
    ...
    void testCacheAndGetInventoryBoosters() {
        ...
        List<InventoryBoosterP> cachedBoosters = inventoryBoosterCacheService.getInventoryBoosters(USER_ID);
        ...
        InventoryBoosterP cachedBooster1 = cachedBoosters.get(0);
    ...
    void testUpdateSingleInventoryBooster() {
        ...
        List<InventoryBoosterP> updatedBoosters = inventoryBoosterCacheService.getInventoryBoosters(USER_ID);

        // Проверяем, что бустер обновился
        assertEquals(2, updatedBoosters.size());

        // Ищем обновленный бустер
        Optional<InventoryBoosterP> foundUpdatedBooster = updatedBoosters.stream()
